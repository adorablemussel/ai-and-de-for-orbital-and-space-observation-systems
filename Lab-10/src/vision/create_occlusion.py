...
# Importujemy logikę ładowania z poprzedniego pliku
...
def create_occlusion_map(model, image_tensor, predicted_class, patch_size=32, stride=16):
    ...
    with torch.no_grad():
        ...
        original_probability = torch.softmax(original_output, dim=1)[0, predicted_class].item()
...
def visualize_occlusion(image, sensitivity):
    ...
    plt.tight_layout()
    # Zapis dla WSL
    output_path = "reports/gradcam_examples/occlusion.png"
