...
# Rozszerzone importy dla wielu metod CAM
...
def visualize(image, heatmap):
    ...
    plt.tight_layout()
    # Zapis zamiast plt.show() dla WSL
    output_path = "reports/gradcam_examples/example.png"
    plt.savefig(output_path)
    print(f"Saved: {output_path}")

# --- Funkcje dodane w późniejszym kroku instrukcji dla wielu CAM ---
